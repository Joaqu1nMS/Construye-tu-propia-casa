👾 Construye tu propia casa - Juego 3D
--
Construye tu propia casa es un videojuego 3D de sigilo y estrategia en primera persona. El jugador asume el papel de un ladrón que debe infiltrarse en la casa de su vecino, para robar todos los objetos que tiene en su lista, pero no puede permitir que le pillen.
...
- **Inteligencia Artificial (NPC):** Vecino con máquina de estado (FSM) que patrulla, investiga ruidos sospechosos y persigue al jugador al detectarlo, con la ayuda de un sistema difuso, que controla las transiciones en base al nivel de sospecha.
